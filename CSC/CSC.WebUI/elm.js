...
_Platform_export({'Main':{'init':$author$project$Main$main(
	$elm$json$Json$Decode$succeed(_Utils_Tuple0))({"versions":{"elm":"0.19.1"},"types":{"message":"Main.Msg","aliases":{},"unions":{"Main.Msg":{"args":[],"tags":{"DraftChanged":["String.String"],"Send":[],"Recv":["String.String"]}},"String.String":{"args":[],"tags":{"String":[]}}}}})}});
